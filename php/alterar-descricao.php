        ...
        <div class="cad-produto">
            ...
            <tr>
                ...
                <tr>
                    ...
                    <td></td>
                    <td></td>
                    <td><a class="botao" href="alterarDescricao.php?id=">Editar</a> 
                    <a class="botao" href="../dataBase/excluir.php?id=" onclick="return confirm('tem certeza que deseja excluir?')">Excluir</a></td>
                <?php }?>
                </div>
            </form>
        </div> 
